...
function Add-PrivateFunction {
    ...
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.2/docs/Functions/Add-PrivateFunction.md
    #>
...
function Add-PublicFunction {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.2/docs/Functions/Add-PublicFunction.md
    #>
...
function Get-BuildEnvironment {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.2/docs/Functions/Get-BuildEnvironment.md
    #>
...
function Import-ModulePrivateFunction {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.2/docs/Functions/Import-ModulePrivateFunction.md
    #>
...
function Import-ModulePublicFunction {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.2/docs/Functions/Import-ModulePublicFunction.md
    #>
...
function Initialize-ModuleBuild {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.2/docs/Functions/Initialize-ModuleBuild.md
    #>
...
function Set-BuildEnvironment {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.2/docs/Functions/Set-BuildEnvironment.md
    #>
