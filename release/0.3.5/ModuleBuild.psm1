...
function Add-PrivateFunction {
    ...
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Add-PrivateFunction.md
    #>
    ...
    process {
        ...
        try {
            ...
            $PrivateFunctionSrc = Join-Path $BuildEnvPath $BuildEnvInfo.PrivateFunctionSource
        ...
        Write-Verbose "Using public function directory: $PrivateFunctionSrc"
        Write-Verbose "Using function template path: $TemplatePath"

        $TemplateData = Get-Content -Path $TemplateLookup[$TemplateName]
        $FunctionFullPath = (Join-Path $PrivateFunctionSrc $Name) + ".ps1"
...
function Add-PublicFunction {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Add-PublicFunction.md
    #>
...
function Get-BuildEnvironment {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Get-BuildEnvironment.md
    #>
...
function Import-ModulePrivateFunction {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Import-ModulePrivateFunction.md
    #>
...
function Import-ModulePublicFunction {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Import-ModulePublicFunction.md
    #>
...
function Initialize-ModuleBuild {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Initialize-Build.md
    #>
...
'@
        ...
        $BuildDefinition = Get-ChildItem (Join-Path -Path $PlasterResults.DestinationPath 'build') -Filter '*.buildenvironment.ps1'
...
function Initialize-ModuleBuild {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Initialize-ModuleBuild.md
    #>
...
function Set-BuildEnvironment {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.5/docs/Functions/Set-BuildEnvironment.md
    #>
